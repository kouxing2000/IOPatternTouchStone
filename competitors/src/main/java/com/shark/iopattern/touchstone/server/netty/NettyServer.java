...
public class NettyServer implements ServerIF{
	...
	public void start(){
		...
		logger.info("DiameterServer TCP_NODELAY is "
				+ ServerConstants.TCP_NODELAY);
		logger.info("DiameterServer socket recv buffer size is set to "
				+ ServerConstants.SOCKET_RECV_BUFFER_SIZE + " bytes");
		logger.info("DiameterServer socket send buffer size is set to "
